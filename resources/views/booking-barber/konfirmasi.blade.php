<x-layout :title="$title">
    @php $layanan = [ 1 => 'Hair Cut', 2 => 'Shaving', 3 => 'Hair Wash', 4 =>
    'Hair Coloring', 5 => 'Creambath & Massage' ]; $harga = [ 1 => 50000, 2 =>
    35000, 3 => 30000, 4 => 150000, 5 => 85000 ]; $barber = [ 1 => 'Alex
    Johnson', 2 => 'Budi Santoso', 3 => 'Rizky Pratama', 4 => 'Dimas Arya' ];
    $total = $harga[request('layanan_id')] ?? 0; @endphp
