                ...
                <div class="kiri">
                    ...
                    <div class="tanggal">
                        ...
                        @for ($i = 0; $i < 7; $i++)
                            ...
                            @endphp
                            <label>
                                <input type="radio" name="tanggal" value="{{ $value }}" class="tgl-radio"
                                    {{ $i === 0 ? 'required' : '' }}>
                                <div class="card-tanggal">{{ $namaHari }}<br>{{ $bulan }} {{ $tanggal }}
                                </div>
                            </label>
                        @endfor
                        ...
                        <label>
                            ...
                            <div class="card-tanggal" id="moreDatesCard" data-bs-toggle="modal"
                    ...
                    <!-- JAM -->
                    <div class="jam">
                        @foreach (['11.00 - 12.00', '12.00 - 12.45', '13.00 - 13.45', '14.00 - 14.45', '15.00 - 15.45', '16.00 - 16.45', '17.00 - 17.45', '18.00 - 18.45', '19.00 - 19.45', '20.00 - 20.45', '21.00 - 22.00'] as $slot)
                            <label>
                    ...
                    <input type="text" name="nama_pelanggan" class="input-diri" placeholder="Nama lengkap" required
                        autocomplete="off">
                    <input type="email" name="email" class="input-diri" placeholder="Email aktif" required
                        autocomplete="off">
                    <input type="text" name="no_hp" class="input-diri" placeholder="No HP (contoh: 08123456789)"
                ...
                <div class="kanan">
                    <div class="step-panel position-sticky" style="top: 20px;">
                        ...
                        <button type="submit" id="btnNext"
                            class="btn btn-primary w-100 py-3 rounded-3 fw-bold shadow-lg" disabled>
