...
<div class="kiri">
    ...
    <div class="jam">
        ...
        <label>
            ...
            <div class="card-jam">12.00 - 12.45<br><small>Tersedia</small></div>
        </label>

        <label>
            <input type="radio" name="jam" class="jam-radio">
            <div class="card-jam">13.00 - 13.45<br><small>Tersedia</small></div>
        </label>

        <label>
            <input type="radio" name="jam" class="jam-radio">
            <div class="card-jam">14.00 - 14.45<br><small>Tersedia</small></div>
        </label>

        <label>
            <input type="radio" name="jam" class="jam-radio">
            <div class="card-jam">15.00 - 15.45<br><small>Tersedia</small></div>
        </label>

        <label>
            <input type="radio" name="jam" class="jam-radio">
            <div class="card-jam">16.00 - 16.45<br><small>Tersedia</small></div>
        </label>
...
<!-- 🔥 LANGKAH RESERVASI = TIDAK DIUBAH SAMA SEKALI -->
...
<button id="btnNext" class="btn btn-primary w-100" disabled>
Selanjutnya
</button>
