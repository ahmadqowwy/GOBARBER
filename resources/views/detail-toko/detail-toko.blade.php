<x-layout>
    ...
    <style>
        ...
        * {
        ...
        /* ======================================================== */
        .btn-booking-main, .tab-btn, .fg-btn-fav, .fg-btn-cart, .service-card, .fg-product-card, .barber-card {
            position: relative;
            overflow: hidden;
        ...
        .btn-booking-main:active, .tab-btn:active, .fg-btn-fav:active, .fg-btn-cart:active {
            transform: scale(0.92) !important;
            transition: transform 0.1s cubic-bezier(0.25, 1, 0.5, 1) !important;
        }
        .service-card:active, .fg-product-card:active, .barber-card:active {
        ...
        .profile-container {
            ...
            border: 1px solid rgba(0, 210, 255, 0.3); /* List border agak kebiruan biar senada */
    ...
    <div class="hero-banner">
        <div class="profile-container">
            <div class="profile-logo-box">
                ...
                <div style="font-size: 20px; font-weight: 800; color: #fff; margin-top: 10px; letter-spacing: 0.5px;">GAMOEN</div>
                <div class="logo-text-sub">.CO BARBERSHOP BWX</div>
            </div>

            <div class="info-content">
                <h1 class="shop-name">GamoenBarbershop</h1>
                <div class="shop-tagline">Hair Avenue</div>
                
                <div class="info-grid">
                    <div class="info-item">
                        <i class="fa-solid fa-location-dot"></i>
                        <span>Jl. Ikan Mas No.44 w58, Karangrejo, Kec. Banyuwangi, Kabupaten Banyuwangi, Jawa Timur 68411, Indonesia.</span>
                    </div>
                    <div class="info-item">
                        <i class="fa-regular fa-clock"></i>
                        <span>12.00-22.00 Mon - Sun</span>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <div class="rating-badge">4.7 <span style="color: #64748b; font-weight: 400; font-size: 11px;">(1000)</span></div>
                    </div>
                </div>
                ...
                <button class="btn-booking-main">Booking Sekarang</button>
            </div>
        </div>
    </div>
        ...
        <div class="figma-shop-section">
            ...
            <div class="shop-left-side">
                <div class="figma-shop-header">
                    ...
                    <p>HIGH HOLD WITH MATTE FINISH FORMING CREAM: A hair styling cream that effortlessly molds hair into the style you want.</p>
                </div>
