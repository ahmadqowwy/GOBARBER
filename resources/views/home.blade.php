        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active position-relative">
                    ...
                    <img src="{{ asset('assets/images/foto1.jpg') }}" class="d-block w-100" alt="foto1">
                ...
                <div class="carousel-item position-relative">
                    ...
                    <img src="{{ asset('assets/images/foto2.jpg') }}" class="d-block w-100" alt="foto2">
                ...
                <div class="carousel-item position-relative">
                    ...
                    <img src="{{ asset('assets/images/foto3.jpg') }}" class="d-block w-100" alt="foto3">
