                                ...
                                <tbody>
                                    @foreach ($shops as $shop)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($shop->photo)
                                                    <img src="{{ $shop->photo }}" alt="Foto Toko"
                                            ...
                                            <td>{{ $shop->location }}</td>
                                            <td>{{ \Carbon\Carbon::parse($shop->open_time)->format('H:i') }} -
                                                {{ \Carbon\Carbon::parse($shop->close_time)->format('H:i') }}</td>
                                            <td>
                                                <a href="{{ route('shop.edit', $shop->shop_id) }}"
                                                    class="btn btn-sm btn-warning">Edit</a>
                                                <form action="{{ route('shop.destroy', $shop->shop_id) }}" method="POST"
